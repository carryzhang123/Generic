package com.hang.ramcache.orm.impl;

import com.hang.ramcache.orm.Paging;
...
public class HibernateQuerier extends HibernateDaoSupport implements Querier{
    ...
    @Override
    public <E> List<E> list(Class clz, Class<E> retClz, String queryname, Object... params) {
    ...
    @Override
    public <E> E unique(Class clz, Class<E> retClz,final String queryname,final Object... params) {
    ...
    @Override
    public <E> List<E> pagint(Class entityClz, Class<E> retClz,final String queryname,final Paging paging,final Object... params) {
        return this.getHibernateTemplate().executeWithNativeSession(new HibernateCallback<List<E>>() {
            @Override
